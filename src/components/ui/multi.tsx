    ...
    return (
      ...
      >
              ...
              return (
                <Badge
                  ...
                  className={cn(
                    ...
                    "data-[fixed]:bg-muted-foreground data-[fixed]:text-muted data-[fixed]:hover:bg-muted-foreground gap-x-1 flex flex-row",
                    badgeClassName
                  )}
        ...
        <div className="relative">
          {open && (
            <CommandList
              className="absolute top-2 z-10 w-full rounded-md border bg-popover text-popover-foreground shadow-md outline-none animate-in py-2"
              onMouseLeave={() => {
